// Enemies to avoid, and vars for x & y axis plus speed
...
Enemy.prototype.update = function(dt) {
    ...
    // Enemy bugs reappear randomly with different speeds after going off canvas
        if (this.x > 510) {
            this.x = -50;
...
// Player character x and y axis vars
...
Player.prototype.handleInput = function (keyPress) {
    ...
    // Once the user reaches the water, the user is
...
function newFunction_2(x, y) {
    newFunction_1(x, y);
}

function newFunction_1(x, y) {
    newFunction(x);
    this.y = y;
}
